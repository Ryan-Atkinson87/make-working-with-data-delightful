...
# df.describe()
# returns basic statistics per column, count, mean, std, min, quartiles

# df.mean()
# returns the mean of each column

# df['py-score'].mean()
# returns the mean of the 'py-score' column

# df.std()
# returns the standard deviation of each column

# df['py-score'].std()
# returns the standard deviation of the py-score column
